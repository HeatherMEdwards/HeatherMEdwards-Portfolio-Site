...
- **Design and update mobile first.** When creating or updating a page, start with the mobile viewport (e.g. ~375px) before desktop.
- Verify layout, tap targets, and font sizing at mobile widths before checking tablet and desktop breakpoints.
...
5. Design and update mobile first.
